...
public class FoodDetailsService implements Service<FoodDetails,Long>{
    @Autowired
    private FoodDetailsRepo repository;


    @Override
    public FoodDetails create(FoodDetails d) {
        try {
    ...
    @Override
    public List<FoodDetails> getAll() {
        try {
...
//    }
    ...
    @Override
    public FoodDetails getOneById(Long id) {
        try {
...
//    }
    ...
    @Override
    public FoodDetails update(FoodDetails d, Long id) {
        try {
    ...
    public FoodDetails get1ByFoodId(Long foodId) {
