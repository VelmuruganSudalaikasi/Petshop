...
import com.treasuremount.petshop.Repository.OrderLogRepo;
import org.springframework.beans.factory.annotation.Autowired;

import java.util.Collections;
import java.util.List;
@org.springframework.stereotype.Service
public class OrderLogService implements Service<OrderLog,Long>{
    @Autowired
    private OrderLogRepo repository;


    @Override
    public OrderLog create(OrderLog d) {
        try {
...
//    }
    ...
    @Override
    public OrderLog getOneById(Long id) {
        try {
...
//    }
    ...
    @Override
    public OrderLog update(OrderLog d, Long id) {
        try {
