...
import com.treasuremount.petshop.Order.Repository.OrderStatusRepo;
...
public class OrderStatusService implements Service<OrderStatusS,Long> {
    @Autowired
    private OrderStatusRepo repository;


    @Override
    public OrderStatusS create(OrderStatusS d) {
        try {
...
//    }
    ...
    @Override
    public OrderStatusS getOneById(Long id) {
        try {
...
//    }
    ...
    @Override
    public OrderStatusS update(OrderStatusS d, Long id) {
        try {
